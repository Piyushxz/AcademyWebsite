        ...
        <>
            <div className="flex justify-between px-6 md:ml-24 md:mr-24">
                <div className="flex justify-center relative">
                    <div className="p-4 md:p-6" onClick={handleLogoClick}>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#0A1128" className="mr-4">
                    <path d="..." />
                </svg>
                Talk to us
                    </button>
